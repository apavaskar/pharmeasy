...
import {selectMenus} from "../../redux/selectors/clientSelector";
import {initMenusStartAction} from "../../redux/actions/client/clientAction";
...
export const AppMenuComponent = (props) => {
    useEffect(() => {
        props.handleInitMenus({
    ...
    return (
        <div className="layout-menu-container" onClick={props.onSidebarClick}>
            <div className="layout-menu-wrapper">
                <AppSubmenu items={props.menus} className="layout-menu" mega={false} root={true}
...
const actions = {
    handleInitMenus: initMenusStartAction
};

export default connect(mapState, actions)(AppMenuComponent);
